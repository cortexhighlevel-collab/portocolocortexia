...
const NovaCamadaSection = () => {
  ...
  return <section id="nova-camada" className="relative bg-background py-24 md:py-32">
            ...
            backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(255,255,255,0.06) 2px, rgba(255,255,255,0.06) 3px)"
              ...
              <div className="grid lg:grid-cols-2">
                ...
                transition: "opacity 0.4s ease"
                    ...
                    <video ref={videoRef} className="absolute inset-0 w-full h-full object-cover" autoPlay muted loop playsInline preload="auto" disablePictureInPicture controls={false} onLoadedMetadata={() => {
                ...
                <div className="relative p-8 md:p-10 lg:p-12">
                  ...
                  <h2 className="md:text-5xl font-bold text-foreground leading-tight text-2xl">Não usamos IA como ferramenta.</h2>
                  <h3 className="md:text-5xl font-bold text-foreground mt-3 leading-tight text-2xl">Criamos sistemas cognitivos.</h3>
