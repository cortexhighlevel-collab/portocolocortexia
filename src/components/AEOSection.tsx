...
const AEOSection = () => {
  return <section id="aeo" className="aeo-section relative overflow-hidden py-32 md:py-48">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 md:px-12">
        ...
        <div className="aeo-compare" aria-label="Comparação SEO tradicional vs AEO">
          <div className="aeo-compare-grid">
            ...
            <motion.div className="aeo-card aeo-card--deprecated" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            duration: 0.5
              ...
              <h3 className="aeo-card-title aeo-card-title--muted text-primary-foreground">SEO Tradicional</h3>
            ...
            {/* Coluna AEO Cortex */}
            <motion.div className="aeo-card aeo-card--active" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
