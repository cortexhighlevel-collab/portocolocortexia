...
function Navbar() {
  ...
  return (
    <MobileMenuContext.Provider value={{ showMenu, setShowMenu }}>
      <nav className="fixed left-0 right-0 top-0 z-[100] px-4 lg:px-8 pt-2 lg:pt-3 scale-[0.8] origin-top">
        <div ref={navRef} className="h-10 mt-1 mx-2 lg:-mt-1 lg:-mx-px w-full relative top-0 inset-x-0 z-40">
