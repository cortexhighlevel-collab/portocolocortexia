...
const HeroSection = () => {
  ...
  return <ImageScrollSequence>
      ...
      position: "relative"
        ...
        <div className="hero-content">
          <div className="hero-content-inner">
            <div className="hero-top-content">
              ...
              >
                <h1 className="hero-headline uppercase font-bold italic text-white scale-[2.4] origin-left -translate-x-[60%]">
                  INTELIGÊNCIA<br />
                  ESTRATÉGICA<br />
                  COM IA
                </h1>

                <p className="hero-headline uppercase font-medium italic text-zinc-400 mt-32 scale-[1.36] origin-left -translate-x-[60%]" style={{
                fontSize: "0.55em",
        ...
        <motion.a href="#contact" className="cyberpunk-cta-wrapper" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
