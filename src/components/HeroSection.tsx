      ...
      <div className="cyberpunk-cta-wrapper">
        ...
        >
          <div className="relative group rounded-full overflow-visible shrink-0">
            ...
            <div 
              className="absolute -inset-[3px] rounded-full opacity-60 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
              style={{
